%{--
Name: _adminDepartment.gsp
Purpose: Displays a list of all departments registered within The CAS to the admin
--}%
<div class="card text-center flex-item">
    <div class="card-header">
        <h2>Departments</h2>
        <i class="fa fa-question-circle" aria-hidden="true" style="float: right; margin-top: -20px" id="department-help"></i>
    </div>
